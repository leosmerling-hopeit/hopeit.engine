...
class SamsaStreamManager(StreamManager):
    ...
    async def write_stream(self, *,
        ...
        res = await self._client.push(batch, stream_name=stream_name, maxlen=target_max_len)
        return res
    ...
    async def read_stream(self, *,
        ...
        """
        try:
            batch = await self._client.consume(
